...
For reproducible downstream releases, use the release tag above or a specific
commit hash. The project targets Lean `v4.31.0` and pins both Mathlib and
Physlib in `lake-manifest.json`. See [REPRODUCE.md](REPRODUCE.md) for a
