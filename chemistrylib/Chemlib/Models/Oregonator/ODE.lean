...
theorem flux_eq_massActionFlux : ∀ (data : OregonatorSourceData)
  ...
  · funext r
    cases r <;>
      simp [flux, fullState, Chemlib.ReactionNetwork.massActionFlux,
        Chemlib.Complex.monomial, oregonatorModel,
...
noncomputable def vectorField (data : OregonatorSourceData) (p : Parameters)
  ...
  Matrix.mulVec
    (Chemlib.Models.SBML.internalStoichiometricMatrix
...
theorem vectorField_spec : ∀ (data : OregonatorSourceData) (p : Parameters)
  ...
  · simp [vectorField, Matrix.mulVec, dotProduct,
      Chemlib.Models.SBML.internalStoichiometricMatrix, includeInternal,
