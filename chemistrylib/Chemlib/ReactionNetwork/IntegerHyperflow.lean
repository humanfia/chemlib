...
structure IntegerHyperflow
    {Species ComplexId ReactionId : Type} [Fintype ReactionId]
    (N : Chemlib.ReactionNetwork Species ComplexId ReactionId) : Type where
...
theorem real_stoichiometric_balance
  ...
  simp [Matrix.mulVec, dotProduct,
    Chemlib.ReactionNetwork.stoichiometricMatrix,
    Chemlib.ReactionNetwork.reactionVector, reactionChangeZ]
