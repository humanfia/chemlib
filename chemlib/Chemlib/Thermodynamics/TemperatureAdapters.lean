...
Thin, assumption-preserving adapters between Chemlib and Physlib's absolute-temperature
...
namespace Chemlib.Thermodynamics
...
/-- The Chemlib adapter is definitionally Physlib's inverse temperature. -/
